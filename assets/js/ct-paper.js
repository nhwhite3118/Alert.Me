...
$(document).ready(function () {
    ...
    $("#btn-unsubscribe").click(function () {
        ...
        var unsubscribeEndpoint = 'http://54.88.241.137:8000/api/unsubscribe/number/' + num;
        console.log("calling " + unsubscribeEndpoint);
        $.ajax({
            url: unsubscribeEndpoint,
            type: 'POST',
            success: function (response) {
                alert("You have removed all alerts for your number from AlertMe.");
            },
    ...
    $("#btn-subscribe").click(function () {
        ...
        event.preventDefault();
        var num = $("#numberInputForm").val();
        var match = $("#matchInputForm").val();
        var site = $("#siteInputForm").val();
        var subscribeEndpoint = 'http://54.88.241.137:8000/api/subscribe/number/' + num + "/matchstr/" + match+ "/site/" + site;
        console.log("calling " + subscribeEndpoint);
        $.ajax({
            url: subscribeEndpoint,
            type: 'POST',
            success: function (response) {
                alert("You have successfully created an alert!");
            },
            error: function (request, status, error) {
                alert("An error occured with our servers, please try again later");
                console.log("request - " + request.toString());
